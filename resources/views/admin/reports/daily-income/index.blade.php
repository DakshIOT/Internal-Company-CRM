...
<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="font-display text-3xl font-semibold text-slate-950">Daily Income report</h1>
            <p class="mt-2 text-sm leading-6 text-slate-600">Admin-only rows and totals from the Daily Income ledger.</p>
        </div>
    </x-slot>
